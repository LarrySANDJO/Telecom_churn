...
def recommendations_page(filtered_df):
    ...
    display_stylized_title("Clients les plus anciens")
    ...
    display_stylized_title("Clients les plus récents")
    ...
    display_stylized_title("Les clients à forte")
    ...
    display_stylized_title("Les clients à plus faible valeur")
    ...
    display_stylized_title("Clients avec un ratio Offnet/Onnet > 3")
    ...
    display_stylized_title("Clients avec un ratio Offnet/Onnet < 1")
    ...
    display_stylized_title("Clients migrant de la 3G à la 2G")
